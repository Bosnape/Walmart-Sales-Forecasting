...
def create_submission(test_df_full, predictions, prediction_info, output_path='submission_lstm.csv'):
...
if __name__ == "__main__":
    ...
    print("\n" + "="*70)
    print("Predicción con LSTM - Test Set")
    print("="*70)
    ...
    print(f"- Modelo LSTM cargado desde lstm_best_model.pt")
